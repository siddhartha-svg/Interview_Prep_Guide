...
### ⭐ **Issue fixed when team is struggling **


**First**, during a **production outage**, the client faced **intermittent 502/504 errors** from the **Ingress Controller**, and multiple engineers couldn’t isolate the root cause. I immediately analyzed **NGINX access logs**, **Ingress annotations**, and **service endpoints**, identifying a **misconfigured timeout** combined with uneven backend pod readiness.
